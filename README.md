...
## My projects:
- Выбор друга (друзей) для встречи, оставление комментариев, изменение профиля пользователей, регистрация/авторизация (React)👫 [Code](https://github.com/wonder-girl92/fast-company) | [Demo](https://wonder-girl92.github.io/fast-company/)
